...
export default function MmlImportButton({ onClick }: { onClick: () => void }) {
  return (
    <div className={`${parentStyles.button} ${styles.import}`} onClick={onClick}>
      <span>Import</span>
      <svg
        width="200"
        height="52"
      ...
      >
        ...
        <path
          className="icon"
          d="M163 34.64V20.65L164.98 20.67V31L165.09 31.11L178.18 18L179.64 19.44L166.53 32.55L166.64 32.66H176.96V34.64H163Z"
          fill="#CBA6FF"
        />
      </svg>
    </div>
